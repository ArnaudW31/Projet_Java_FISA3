...
public class TiragePoulieHaute extends ExercicePoulie {
    ...
    //constructeur
    public TiragePoulieHaute(int id, String nom, String categorie, String description, String prisePoulie, int hauteurPoulie) {
        super(id, nom, "Dos", "1. Asseyez-vous à la machine de tirage à la poulie haute, les pieds bien posés sur le sol.\n" +
