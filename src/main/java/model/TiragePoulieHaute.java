...
public class TiragePoulieHaute extends ExercicePoulie {
    ...
    public TiragePoulieHaute(int id, String nom) {
        ...
        "Tu tires depuis le bas", "prise large",  18);
    }

    public VBox showExplanation() {
        VBox box = new VBox(new Label("1. Asseyez-vous à la machine de tirage à la poulie haute, les pieds bien posés sur le sol.\n" +
